//
//  ActivityIndicatorAnimationLineSpinFadeLoader.swift
...
class ActivityIndicatorAnimationLineSpinFadeLoader: ActivityIndicatorAnimationDelegate {
    ...
    func lineAt(angle: CGFloat, size: CGSize, origin: CGPoint, containerSize: CGSize, color: NSColor) -> CALayer {
        ...
        let line = ActivityIndicatorShape.line.layerWith(size: size, color: color)
