//
//  ActivityIndicatorBallClipRotate.swift
...
class ActivityIndicatorAnimationBallClipRotate: ActivityIndicatorAnimationDelegate {
    ...
    func setUpAnimation(in layer: CALayer?, size: CGSize, color: NSColor) {
        ...
        // Draw circle
        let circle = ActivityIndicatorShape.ringThirdFour.layerWith(size: CGSize(width: size.width, height: size.height), color: color)
