//
//  ActivityIndicatorAnimationBallScaleRippleMultiple.swift
...
class ActivityIndicatorAnimationBallScaleRippleMultiple: ActivityIndicatorAnimationDelegate {
    ...
    func setUpAnimation(in layer: CALayer?, size: CGSize, color: NSColor) {
        ...
        // Draw circles
        for i in 0 ..< 3 {
            let circle = ActivityIndicatorShape.ring.layerWith(size: size, color: color)
