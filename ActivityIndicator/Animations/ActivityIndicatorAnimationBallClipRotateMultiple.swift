...
class ActivityIndicatorAnimationBallClipRotateMultiple: ActivityIndicatorAnimationDelegate {
    ...
    func circleOf(shape: ActivityIndicatorShape, duration: CFTimeInterval, timingFunction: CAMediaTimingFunction, layer: CALayer, size: CGFloat, color: NSColor, reverse: Bool) {
