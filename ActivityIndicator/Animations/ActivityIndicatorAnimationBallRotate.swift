//
//  ActivityIndicatorAnimationBallRotate.swift
...
class ActivityIndicatorAnimationBallRotate: ActivityIndicatorAnimationDelegate {
    ...
    func setUpAnimation(in layer: CALayer?, size: CGSize, color: NSColor) {
        ...
        // Draw circles
        let leftCircle = ActivityIndicatorShape.circle.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
        let rightCircle = ActivityIndicatorShape.circle.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
        let centerCircle = ActivityIndicatorShape.circle.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
