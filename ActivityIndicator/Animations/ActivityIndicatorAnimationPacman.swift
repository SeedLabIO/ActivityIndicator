//
//  ActivityIndicatorAnimationPacman.swift
...
class ActivityIndicatorAnimationPacman: ActivityIndicatorAnimationDelegate {
    ...
    func pacmanInLayer(_ layer: CALayer, size: CGSize, color: NSColor) {
        ...
        // Draw pacman
        let pacman = ActivityIndicatorShape.pacman.layerWith(size: CGSize(width: pacmanSize, height: pacmanSize), color: color)
        let frame = CGRect(
