//
//  ActivityIndicatorAnimationAudioEqualizer.swift
...
class ActivityIndicatorAnimationAudioEqualizer: ActivityIndicatorAnimationDelegate {
    ...
    func setUpAnimation(in layer: CALayer?, size: CGSize, color: NSColor) {
        ...
        for i in 0 ..< 4 {
            ...
            for j in 0 ..< values.count {
                ...
                path.appendRect(CGRect(origin: point, size: CGSize(width: lineSize, height: height)))
