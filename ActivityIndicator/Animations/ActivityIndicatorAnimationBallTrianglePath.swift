//
//  ActivityIndicatorAnimationBallTrianglePath.swift
...
class ActivityIndicatorAnimationBallTrianglePath: ActivityIndicatorAnimationDelegate {
    ...
    func setUpAnimation(in layer: CALayer?, size: CGSize, color: NSColor) {
        ...
        // Top-center circle
        let topCenterCircle = ActivityIndicatorShape.ring.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
        ...
        // Bottom-left circle
        let bottomLeftCircle = ActivityIndicatorShape.ring.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
        ...
        // Bottom-right circle
        let bottomRightCircle = ActivityIndicatorShape.ring.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
