//
//  ActivityIndicatorAnimationOrbit.swift
...
class ActivityIndicatorAnimationOrbit: ActivityIndicatorAnimationDelegate {
    ...
    func ring1InLayer(_ layer: CALayer, size: CGSize, color: NSColor) {
        ...
        // Draw circle
        let circle = ActivityIndicatorShape.circle.layerWith(size: CGSize(width: coreSize, height: coreSize), color: color)
    ...
    func satelliteInLayer(_ layer: CALayer, size: CGSize, color: NSColor) {
        ...
        path.appendArc(
            withCenter: CGPoint(x: layer.bounds.midX, y: layer.bounds.midY),
        ...
        // Draw circle
        let circle = ActivityIndicatorShape.circle.layerWith(size: CGSize(width: satelliteSize, height: satelliteSize), color: color)
